...
!!! warning "Migration Warnings to Update"
    ...
    - We have not been able to test live migration of SoundCloud media assets. If you have SoundCloud media assets, please contact us if there are any issues, or if you are willing to share your database with us for testing.
...
![pre-migration-media-03](../_embeds/pre-migration-media-06.png)
...
![pre-migration-content-05](../_embeds/pre-migration-media-08.png)
