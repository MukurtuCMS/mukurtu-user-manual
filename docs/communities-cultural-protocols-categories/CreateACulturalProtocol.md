...
1. As a community manager, from the Mukurtu Dashboard, select **Add a cultural protocol**
     ...
     ![A screeshot of the Mukurtu dashboard with the Add a cultural protocol link highlighted](../_embeds/create-protocol-01.png) 
...
4. Select "Select Communities." A window will open that lists all communities of which you are a community manager. Select each community you wish to add, and select "Add communities."
    ...
    ![The add communities modal, with all available communities displayed. Two communities are selected, indicated by a green outline. The add communities button is located at the bottom left.](../_embeds/create-protocol-05.png) 
...
2. Add a *protocol name*, and select a *protocol type* by selecting one of:
    ...
    ![Screen shot of the create protocol form. At the top is the protocol name field with text box, the sharing settings field with radio buttons next to two options labled strict and open.](../_embeds/create-protocol-14.png)
...
4. Select "Select Communities." A window will open that lists all communities of which you are a community manager. Select each community you wish to add, and select "Add communities."
    ...
    ![Communities field with select communities button](../_embeds/create-protocol-24.png) 
