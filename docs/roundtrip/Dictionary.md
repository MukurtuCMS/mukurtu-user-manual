...
|Field Name|Description|Format Information|
|---|---|---|
|Import ID, ID, or UUID|When importing a dictionary word and corresponding sample sentences at the same time, use an *Import ID*|See [General Import Information > Identifiers](../roundtrip/GeneralImportInformation.md/#identifiers-id-uuid-import-id) for more information.|
