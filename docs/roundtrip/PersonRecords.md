...
Users can include media assets in formatted text fields such as the Biography or Location description fields using the following syntax. The syntax are presented in order of our recommended methods. 
