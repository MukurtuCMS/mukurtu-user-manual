...
- UI and configuration translation links
...
### Translate Local Contexts 

## Translate content

    - Translate all content as part of workflow - can go back and input translations later but that way it'll show up properly
