...
4. Enter the name of your SoundCloud asset is automatically generated. If necessary, you can edit the name of your SoundCloud asset by editing the text in the *Name* field.
...
8. SoundCloud assets are represented by an interactive media player instead of a thumbnail image by default. You may choose to add a thumbnail to your SoundCloud asset.
...
9. In the *Identifier* field, provide a unique identifier for the SoundCloud asset. This identifier is usually an accession number, catalogue number, or other unique identifier.
