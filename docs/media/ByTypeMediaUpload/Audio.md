...
3. In the **Audio file** field, select the "Choose File" or "Browse" button to upload an audio file. 
    ...
    ![Screenshot of the Browse button to upload a file along with a blank filename field.](../docs/_embeds/Audio1.png)
...
![Screenshot of the file and filename showing how it automatically filled in.](..docs/_embeds/Audio2.png)
