...
Digital heritage items generally feature at least one media asset, and can contain multiple media assets as metadata in the cultural narrative, traditional knowledge, and description fields. One use case for videos is as descriptive metadata in these fields, where they can provide unique cultural context and information for the digital heritage item. Digital heritage items also allow multi-page items, which can compile multiple media assets into one digital heritage item. One common use for the multi-page items feature is to showcase a yearbook or newspaper. 
