...
Trigger the error and then as an administrator or Mukurtu manager, go to `/admin/reports/dblog` (eg: https://myURL.com/admin/reports/dblog)
...
![The error logs with one yellow error highlighted. The type and severity menus are also highlighted.](../_embeds/error-log-01.png)

Click the message preview to view the full message. 

![The error log with a message preview highlighted](../_embeds/error-log-02.png)

We recommend capturing a screenshot of the full message(s).

![A full error message](../_embeds/error-log-03.png)