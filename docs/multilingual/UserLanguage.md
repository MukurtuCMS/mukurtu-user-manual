...
6. You will receive a confirmation message in your chosen language.
    ...
    ![Screenshot of the confirmation message and the user preferences page in French.](../_embeds/user6.png)
...
2. From the *Site language* field, select a language from the dropdown menu.
    ...
    ![Screenshot of the Language settings section of the user account registration page.](../_embeds/user7.png)

3. Select the "Create new account" button to save the new user account.

    ![Screenshot of the user account registration page with the create new account button highlighted.](../_embeds/user8.png)
...
2. Navigate to the user account and select the "Edit" button. 
    ...
    ![Screenshot of the manage users page with the edit button highlighted for the user translation_example](../_embeds/user10.png)
