# Understanding Mukurtu Multilingual

The updated Mukurtu Multilingual module allows users to fully translate and localize their Mukurtu sites into one or more languages. **Translation** is (at the simplest level) converting words from one language to another. **Localization** is the process of adapting content and structure more exhaustively for another language. Users can easily toggle between languages using the "Language Switcher" button.
