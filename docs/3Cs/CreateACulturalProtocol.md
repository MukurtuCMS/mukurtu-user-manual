...
4. Under the appropriate user role, select "Select Member"
    ...
    -  User the search bar to search for a community or select from the list of community members below. Select "Add Users." 
    - Once added, you can remove users by selecting the trash can icon under their username. 
...
6. When you are finished, select "Save and Create Another Protocol" if you have additional protocols to add, or "Save" if you are finished. These buttons are sticky at the top of the page. You can add additional protocols later using these steps.
    ...
    ![The create protocol form with the save buttons highlighted in a red box at the top of the page.](../_embeds/create-protocol-10.png)
    ...
    ![The manage community page with a confirmation message displayed](../_embeds/create-protocol-13.png)
