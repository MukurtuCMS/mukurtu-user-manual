...
In a Mukurtu site, protocols typically belong to one community. At times, however, related families, villages, clans, or other communities might want to manage access to certain shared pieces of content with the same set of protocols while keeping their communities distinct. This is possible by adding multiple communities to a protocol. This article covers creating multi-community protocols, managing membership, applying them to content, and what to expect in front-end display.

## Creating a multi-community protocol
Community managers of more than one community can create a multi-community protocol for the communities they manage. 
...
![The add protocol form with Community 1 and Community 2 listed as parent communities of the multi-community protocol. The parent communities are highlighted](../_embeds/multi-comm-protocol-10.png)
...
On the community pages of both parent communities, you'll find the multi-community protocol listed under **Cultural Protocols**

![The community page of Community 1 with the multi-community protocol listed under cultural protocols](../_embeds/multi-comm-protocol-07.png)

![The community page of Community 2 with the multi-community protocol listed under cultural protocols](../_embeds/multi-comm-protocol-11.png)

## Managing multi-community protocols
Like any other protocol, protocol stewards manage multi-community protocols. Protocol stewards can belong to any parent community, and do not need to belong to all communities to manage the protocol. The community manager who created the protocol is automatically a protocol steward. Each site should determine their own guidelines for managing multi-community protocols. For example, should each parent community have a protocol steward, or is one protocol steward sufficient, regardless of community membership? 
...
A multi-community protocol will display in the same format. However, because the protocol has multiple parent communities, it will be repeatedly listed with each parent community. 

Note that access to a multi-community protocol does not mean access to every parent community. In the screenshot below, this user is only a member of Community 1. They can access their community and the multi-community protocol. The user does not belong to Community 2 (a strict community), and therefore does not have access to that community page. 
...
On the browse page, a content item will display all associated communities based on the protocol(s) assigned to the item. Whether the protocol is a multi-community protocol makes no difference in display. In the screenshot below, Item 1 is assigned one multi-community protocol, with Community 1 and Community 2 as parent communities. Item 2 is assigned two single community protocols, one each from Community 1 and Community 2. 
