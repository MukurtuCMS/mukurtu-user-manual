...
Depending on your registration settings, some of these fields in this form may not be visible. To configure those settings, see [Manage User Account Registration](../users/manage-user-account-registration.md).
...
3. Once the form is open, add a username and optional email address.
...
6. It might make sense for users to be added to other communities and protocols on the site. If this is the case, you may choose notify other community managers and protocol stewards about the new user so they can review their account and add them to their groups as appropriate. You can also use the **Notify specific users** field to notify specific administrators, Mukurtu managers, community managers and protocol stewards. 

    ![Notification options for notifying other users about the new account. This includes notifying all community managers in the community, notifying all protocol stewards within the community, and notifying specific users.](../_embeds/add-user-cm-07.png)
...
6. If you are also a protocol steward for protocols within the community, the protocols you steward will be exposed once you assign community roles. Select the appropriate roles for each community and protocol and select "Create new account."
    ...
    ![A list of available communities and protocols with exposed user roles for each group. The community member, contributor and language contributor roles are selected.](../_embeds/add-user-cm-06.png)
