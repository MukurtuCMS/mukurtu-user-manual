...
When you receive an account request in your email inbox, click on the link included in the email. It will take you to the user's edit page. Here you will see all the account settings selected by the user when they created the account request.
