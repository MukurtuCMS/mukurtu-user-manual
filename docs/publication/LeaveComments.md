...
![A content page with a comment box](../_embeds/leave-comment-01.png)
...
![The comment box with a sample comment. The CAPTCHA filter is checked. The save button is below the CAPTCHA filter](../_embeds/leave-comment-02.png)
...
![The comment success message indicating that the comment is under review](../_embeds/leave-comment-03.png)
...
![A content item with success message and comment displayed below the content](../_embeds/leave-comment-04.png)
...
![An existing comment with the reply button highlighted](../_embeds/leave-comment-05.png)
...
![A page with the existing comment and empty comment box.](../_embeds/leave-comment-06.png)
...
![The content page with success message and comment thread below the content](../_embeds/leave-comment-07.png)
