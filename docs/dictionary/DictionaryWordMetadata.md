...
- The glossary entry is used for indexing when a character or letter other than the first character in the term should be referenced. 
...
- For roundtrip, provide the IDs, UUIDs, or titles of the recording, separated by your selected multi-value delimiter. Each title must be exact and match only one recording.
...
- For roundtrip, provide the taxonomy term names, IDs, or UUIDs, separated by your selected multi-value delimiter. Each name must be exact and match only one term in that vocabulary. New terms will be created if they do not already exist.
...
- For roundtrip, provide the ID or UUIDs of the paragraphs, separated by your selected multi-value delimiter.
...
- For roundtrip, provide the ID, UUID, or title of the image, title must be exact and match only one image.
...
- For roundtrip, provide the IDs, UUIDs, or titles of the media asset, separated by your selected multi-value delimiter. Each title must be exact and match only one media asset.
...
- For roundtrip, provide the Local Contexts Project ID values, separated by your selected multi-value delimiter.
