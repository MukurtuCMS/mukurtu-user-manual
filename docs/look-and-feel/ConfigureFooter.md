...
![Screenshot of the content blocks page with the Mukurtu footer link and the associated edit button highlighted.](../_embeds/footer2.png)
...
![Screenshot of the block description and footer text fields with text and images included in the footer text field.](../_embeds/footer3.png)
...
1. Select the "Add Footer Logo" button.
    ...
    ![Screenshot of the edit content block Mukurtu footer page with the Add footer logo button highlighted.](../_embeds/footer4.png)
...
3. Add a link to the optional *Link URL* field. You can use an internal path such as `/node/add/` or an external URL such as https://www.example.com. Enter `<front>` to link to the front page.
    ...
    ![Screenshot of the Logos section featuring the logo image and link URL fields with the browse button highlighted.](../_embeds/footer5.png)

    ![Screenshot of the logos section featuring the logo image and link URL fields with an image, alt text, and link URL filled in.](../_embeds/footer6.png)
...
3. You can add additional links by selecting the "Add another item" button.
    ...
    ![Screenshot of the other links fields.](../_embeds/footer10.png)
...
![Screenshot of the edit content block Mukurtu footer with the save button highlighted.](../_embeds/footer12.png)